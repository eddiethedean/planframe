...
class Frame(Generic[SchemaT, BackendFrameT, BackendExprT]):
    ...
    @overload
    def explode(self, column: str) -> Self: ...
    def explode(self, column: Any) -> Self: ...
    @overload
    def unnest(self, column: LiteralString, *, fields: tuple[LiteralString, ...]) -> Self: ...
    @overload
    def unnest(self, column: str, *, fields: tuple[str, ...]) -> Self: ...
    def unnest(self, column: Any, *, fields: tuple[Any, ...]) -> Self: ...
    @overload
