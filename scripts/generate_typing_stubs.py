...
def _render_frame_pyi(*, max_arity: int = 10) -> str:
    ...
    a("        outer: bool = ...,")
    a("    ) -> Self: ...")
    a("    def explode(self, *columns: Any, outer: bool = ...) -> Self: ...")
    a("    @overload")
    a("    def unnest(self, __c1: LiteralString, *columns: LiteralString) -> Self: ...")
    a("    @overload")
    a("    def unnest(self, __c1: str, *columns: str) -> Self: ...")
    a("    def unnest(self, *columns: Any) -> Self: ...")
    a("    def posexplode(")
    a("        self,")
    a("        column: LiteralString,")
    a("        *,")
