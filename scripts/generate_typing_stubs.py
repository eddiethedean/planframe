...
def _render_frame_pyi(*, max_arity: int = 10) -> str:
    ...
    a("    def explain(self, *_: object, **__: object) -> NoReturn: ...")
    a("    def profile(self, *_: object, **__: object) -> NoReturn: ...")
    a("    def show_graph(self, *_: object, **__: object) -> NoReturn: ...")
    a("")
    ...
    a("    @overload")
    a(
        "    def select(self, *columns: LiteralString | tuple[str, Expr[Any]] | Expr[Any], **named_exprs: Expr[Any]) -> Self: ..."
    )
    ...
    a("    def rename_upper(self, *subset: LiteralString, strict: bool = ...) -> Self: ...")
    a("    def rename_lower(self, *subset: LiteralString, strict: bool = ...) -> Self: ...")
    a("    def rename_title(self, *subset: LiteralString, strict: bool = ...) -> Self: ...")
    a("    def rename_strip(")
    a("        self,")
    ...
    a("        self,")
    a("        *,")
    a("        lower: Expr[object] | Scalar | None = ...,")
    ...
    a("    def filter(self, *predicates: Expr[bool]) -> Self: ...")
    a("    def cache(self) -> NoReturn: ...")
    a("    def sql(self, query: str, *, table_name: str = ...) -> NoReturn: ...")
    a("    def map_batches(self, *_: object, **__: object) -> NoReturn: ...")
    a("    def pipe(self, *_: object, **__: object) -> NoReturn: ...")
    for n in range(1, max_arity + 1):
    ...
    a("        strategy: str,")
    a("    ) -> Self: ...")
    a("    def fill_null_subset(")
    a("        self,")
    a("        value: Scalar | Expr[Any] | None = ...,")
    a("        *columns: LiteralString,")
    a("        strategy: str | None = ...,")
    a("    ) -> Self: ...")
    a("    def fill_null_many(")
    a("        self,")
    ...
    a("        self,")
    a("        *,")
    a("        index: tuple[LiteralString, ...] | None = ...,")
    a("        on: tuple[LiteralString, ...] | None = ...,")
    a("        variable_name: str = ...,")
    a("        value_name: str = ...,")
    a("    ) -> Self: ...")
    a("")
    ...
    a("        names_from: LiteralString,")
    a("        values_from: LiteralString | tuple[LiteralString, ...],")
    a(
        '        aggregate_function: Literal["first", "last", "sum", "mean", "min", "max", "count", "len", "median"] = ...,'
    )
    a("        on_columns: tuple[LiteralString, ...] | None = ...,")
    a("        sort_columns: bool = ...,")
    a("        separator: str = ...,")
    a("    ) -> Self: ...")
    a("")
    ...
    a("        *,")
    a("        index: tuple[LiteralString, ...],")
    a("        columns: LiteralString | None = ...,")
    a("        on: LiteralString | None = ...,")
    a("        values: LiteralString | tuple[LiteralString, ...],")
    a(
